...
class OrderQueryDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, minimum: 1 }, pageSize: { required: false, type: () => Number, minimum: 1 }, status: { required: false, enum: require("../../common/enums/order-status.enum").OrderStatus } };
    }
}
